...
func makeConfigNode(ctx *cli.Context) (*node.Node, gethConfig) {
	...
	cfg.Node.HTTPTimeouts = rpc.HTTPTimeouts{
...
func makeFullNode(ctx *cli.Context) (*node.Node, ethapi.Backend) {
	...
	cfg.Eth.GCacheForFileSotreDisable = ctx.GlobalBool(utils.GCacheForFileStoreDisableFlag.Name)
	cfg.Eth.GCacheFileSize = ctx.GlobalInt(utils.GCacheFileSizeFlag.Name)
	cfg.Eth.GCacheForMemoryDisable = ctx.GlobalBool(utils.GCacheForMemoryDisableFlag.Name)
	cfg.Eth.GCacheMemorySize = ctx.GlobalInt(utils.GCacheMemorySizeFlag.Name)
