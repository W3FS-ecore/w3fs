...
func initGenesis(ctx *cli.Context) error {
	...
	// init nela storage provider config
	r, lr, cfg1 := storage.InitStorageProviderConfig(&cfg.Node)
	if r == nil || lr == nil || cfg1 == nil {
		log.Error("Initializing nela provider config error")
	}
	lr.Close()
