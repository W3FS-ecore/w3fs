...
func (ec *Client) EstimateGasLatest(ctx context.Context, msg ethereum.CallMsg) (uint64, error) {
	var hex hexutil.Uint64
	err := ec.c.CallContext(ctx, &hex, "eth_estimateGas", toCallArg(msg) , "latest")
	if err != nil {
		return 0, err
	}
	return uint64(hex), nil
