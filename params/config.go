...
type ChainConfig struct {
	...
	Bor    *BorConfig    `json:"w3fs,omitempty"`
}
...
type BorConfig struct {
	...
	PorepDelay				 uint64			`json:"porepDelay"`			   // Number of seconds delay between Porep
	//ProofType                string         `json:"proofType"`			   // winning post proof type
