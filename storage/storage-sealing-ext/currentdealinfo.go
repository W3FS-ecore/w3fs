...
type CurrentDealInfoAPI interface {
	...
	StateLookupID(context.Context, address.Address, sealing.TipSetToken) (address.Address, error)
	StateMarketStorageDeal(context.Context, abi.DealID, sealing.TipSetToken) (*api.MarketDeal, error)
	StateSearchMsg(context.Context, cid.Cid) (*MsgLookup, error)
	StateNetworkVersion(ctx context.Context, tok sealing.TipSetToken) (network.Version, error)
}

type CurrentDealInfo struct {
	DealID           abi.DealID
	MarketDeal       *api.MarketDeal
	PublishMsgTipSet sealing.TipSetToken
}
...
func (mgr *CurrentDealInfoManager) GetCurrentDealInfo(ctx context.Context, tok sealing.TipSetToken, proposal *market.DealProposal, publishCid cid.Cid) (CurrentDealInfo, error) {
...
func (mgr *CurrentDealInfoManager) dealIDFromPublishDealsMsg(ctx context.Context, tok sealing.TipSetToken, proposal *market.DealProposal, publishCid cid.Cid) (abi.DealID, sealing.TipSetToken, error) {
	dealID := abi.DealID(0)
...
func (mgr *CurrentDealInfoManager) CheckDealEquality(ctx context.Context, tok sealing.TipSetToken, p1, p2 market.DealProposal) (bool, error) {
...
func (c *CurrentDealInfoAPIAdapter) StateLookupID(ctx context.Context, a address.Address, tok sealing.TipSetToken) (address.Address, error) {
...
func (c *CurrentDealInfoAPIAdapter) StateMarketStorageDeal(ctx context.Context, dealID abi.DealID, tok sealing.TipSetToken) (*api.MarketDeal, error) {
	tsk, err := types.TipSetKeyFromBytes(tok)
	if err != nil {
...
func (c *CurrentDealInfoAPIAdapter) StateNetworkVersion(ctx context.Context, tok sealing.TipSetToken) (network.Version, error) {
	tsk, err := types.TipSetKeyFromBytes(tok)
	if err != nil {
