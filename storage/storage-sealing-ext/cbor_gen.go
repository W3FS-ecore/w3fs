...
func (t *SectorInfo) MarshalCBOR(w io.Writer) error {
	...
	// t.SectorType (abi.RegisteredSealProof) (int64)
	if len("SectorNewType") > cbg.MaxLength {
		return xerrors.Errorf("Value in field \"SectorNewType\" was too long")
	}

	if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajTextString, uint64(len("SectorNewType"))); err != nil {
		return err
	}
	if _, err := io.WriteString(w, string("SectorNewType")); err != nil {
		return err
	}

	if t.SectorNewType >= 0 {
		if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajUnsignedInt, uint64(t.SectorNewType)); err != nil {
			return err
		}
	} else {
		if err := cbg.WriteMajorTypeHeaderBuf(scratch, w, cbg.MajNegativeInt, uint64(-t.SectorNewType-1)); err != nil {
			return err
		}
	}
	...
	*t = SectorInfo{}
	...
	for i := uint64(0); i < n; i++ {
		...
		case "Pieces":
			...
			if extra > 0 {
				t.Pieces = make([]sealing.Piece, extra)
			}
		...
		case "Log":
			...
			// t.SectorNewType (RegisteredSectorType) (int64)
		case "SectorNewType":
			{
				maj, extra, err := cbg.CborReadHeaderBuf(br, scratch)
				var extraI int64
				...
				t.SectorNewType = RegisteredSectorType(extraI)
			}
