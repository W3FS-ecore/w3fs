...
type Chain interface {
	ChainHead(ctx context.Context) (sealing.TipSetToken, abi.ChainEpoch, error)
...
type BasicPreCommitPolicy struct {
	api              Chain
	getSealingConfig sealing.GetSealingConfigFunc
...
func NewBasicPreCommitPolicy(api Chain, cfgGetter sealing.GetSealingConfigFunc, provingBuffer abi.ChainEpoch) BasicPreCommitPolicy {
