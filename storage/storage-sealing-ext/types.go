...
type RegisteredSectorType int64

const (
	SectorStorage = RegisteredSectorType(0)
	SectorPledge  = RegisteredSectorType(1)
)
...
type SectorInfo struct {
	...
	PreCommitTipSet  sealing.TipSetToken
	...
	//pledge sectors identify
	SectorNewType RegisteredSectorType
