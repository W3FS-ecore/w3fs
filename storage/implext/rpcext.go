...
func ServeRPC(h http.Handler, id string, addr multiaddr.Multiaddr) (node.StopFunc, error) {
...
func MinerHandler(a api.StorageMiner, permissioned bool) (http.Handler, error) {
	...
	m.PathPrefix("/remote").HandlerFunc(a.(*StorageMinerAPI).ServeRemote(permissioned))
