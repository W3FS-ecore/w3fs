...
func (b *LesApiBackend) TestStr() string {
	panic("implement me")
}

func (b *LesApiBackend) ClientManager() ethapi.ClientManager {
	panic("implement me")
}
...
func (b *LesApiBackend) GetP2pServer() *p2p.Server {
	panic("implement me")
}

func (b *LesApiBackend) GetMinerApi() *api.StorageMiner {
	panic("implement me")
}

func (b *LesApiBackend) GetMockFullApi() *mock.MockFullNode {
	panic("implement me")
}

func (b *LesApiBackend) GetDataDir() string {
	panic("implement me")
}

func (b *LesApiBackend) GetMinerAddr() *string {
	panic("implement me")
}

func (b *LesApiBackend) GetFinshCh() <-chan struct{} {
	panic("implement me")
}
