...
func (b *EthAPIBackend) ClientManager() ethapi.ClientManager {
	return b.eth.ClientManager()
}

func (b *EthAPIBackend) GetMinerApi() *api.StorageMiner {
	return b.eth.GetMinerApi()
}

func (b *EthAPIBackend) GetMockFullApi() *mock.MockFullNode {
	return b.eth.GetMockFullApi()
}

func (b *EthAPIBackend) GetFinshCh() <-chan struct{} {
	return b.eth.GetFinshCh()
}

func (b *EthAPIBackend) GetP2pServer() *p2p.Server {
	return b.eth.GetP2pServer()
}

func (b *EthAPIBackend) GetDataDir() string {
	return b.eth.GetDataDir()
}

func (b *EthAPIBackend) GetMinerAddr() *string {
	return b.eth.GetMinerAddr()
}
...
func (b *EthAPIBackend) TestStr() string {
	return b.eth.TestStr()
}
